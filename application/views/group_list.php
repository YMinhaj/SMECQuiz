...
<tr>
 ...
 <th><?php echo "SMEC Pass Serial"//$this->lang->line('price'); ?></th>
...
<td>
 ...
 <input type="text"   class="form-control"   name="valid_for_days" value="0" placeholder="<?php echo ""//$this->lang->line('valid_for_days');?>"  required ></td>
<td>
