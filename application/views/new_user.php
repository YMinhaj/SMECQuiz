 ...
 <div class="login-panel panel panel-default">
		...
		?>	
			...
			<div class="form-group">	  
				...
				<div class="form-group">	 
					<label for="inputEmail" class="sr-only"><?php echo "1st Member Name"//$this->lang->line('first_name');?></label> 
					<input type="text"  name="first_name"  class="form-control" placeholder="<?php echo "1st Member Name"//$this->lang->line('first_name');?>"   autofocus>
			</div>
				<div class="form-group">	 
					<label for="inputEmail" class="sr-only"><?php echo "2nd Member Name"//$this->lang->line('last_name');?></label> 
					<input type="text"   name="last_name"  class="form-control" placeholder="<?php echo "2nd Member Name"//$this->lang->line('last_name');?>"   autofocus>
			</div>
				<div class="form-group">	 
