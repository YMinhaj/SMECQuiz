	...
	?>
        ...
        <div class="container-fluid">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"><?php echo "SMEC 'Network Designing'" ;?></a>
          </div>
          <div id="navbar" class="navbar-collapse collapse">
		    ...
		    <?php 
					 ...
					 //<li><a href="<?php echo site_url('user/edit_user/'.$logged_in['uid']);?><?php //echo $this->lang->line('myaccount');?>
...
<li><a href="<?php echo site_url('result');?>"><?php echo $this->lang->line('result');?></a></li>
			...
			<?php 
             ...
             <p align="right"><a href="">Created By Yousuf Minhaj.</a></p>
